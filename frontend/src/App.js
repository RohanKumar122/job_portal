      ...
      <main className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mt-4 sm:mt-8">
          {loading ? (
            ...
            <div className="bg-red-500/10 border border-red-500/20 rounded-2xl sm:rounded-3xl p-8 sm:p-12 text-center max-w-2xl mx-auto">
            ...
            <div className="text-center py-12 sm:py-24 bg-white/5 border border-white/5 rounded-2xl sm:rounded-3xl">
...
function JobCard({ job }) {
  ...
  return (
    <div className="group relative bg-[#1e293b]/40 hover:bg-[#1e293b]/80 border border-white/5 rounded-2xl sm:rounded-[2rem] p-5 sm:p-8 transition-all duration-500 hover:shadow-[0_20px_50px_rgba(79,70,229,0.15)] hover:-translate-y-1 sm:hover:-translate-y-2 backdrop-blur-sm overflow-hidden">
      {/* Accent Line */}
      ...
      <div className="flex flex-col h-full">
        <div className="flex justify-between items-start mb-4 sm:mb-6">
          <div className="flex-1 min-w-0">
            ...
            <h3 className="text-lg sm:text-2xl font-bold text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-indigo-300 group-hover:bg-clip-text transition-all duration-300 leading-tight truncate">
              {job.name}
            </h3>
          ...
          <div className="hidden sm:block p-3 bg-white/5 rounded-2xl border border-white/5 opacity-0 group-hover:opacity-100 transition-all duration-300">
        ...
        <div className="mt-auto flex items-center justify-between gap-4">
          <div className="flex flex-col min-w-0">
            <span className="text-[8px] sm:text-[10px] font-bold text-slate-500 uppercase tracking-widest border-l-2 border-indigo-500/50 pl-2">Job Type</span>
            <span className="text-xs sm:text-sm font-bold text-slate-300 ml-2 mt-0.5 sm:mt-1 truncate">{job.workLocationOption || 'Full-time'}</span>
          </div>
          <a
            href={job.positionUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="flex-shrink-0 inline-flex items-center justify-center bg-indigo-600 hover:bg-indigo-500 text-white font-black py-2 sm:py-3.5 px-6 sm:px-8 rounded-xl sm:rounded-2xl transition-all shadow-xl shadow-indigo-600/20 active:scale-95 text-xs sm:text-sm"
          >
            Apply
          </a>
        </div>
